...
class ControllerModuleDBlogModule extends Controller {
    private $codename = 'd_blog_module';
    private $route = 'module/d_blog_module';
    ...
    public function __construct($registry) {
        ...
        $this->config_file = $this->model_module_d_blog_module->getConfigFile($this->codename, $this->sub_versions);
    ...
    public function index(){
        ...
        $this->model_module_d_blog_module->updateTables();
        ...
        //get setting
        $data['setting'] = $this->model_module_d_blog_module->getConfigData($this->codename, $this->codename.'_setting', $this->store_id, $this->config_file);
        
        //demo
        $data['demos'] = $this->model_module_d_blog_module->getDemos();
        ...
        $data['themes'] = $this->model_module_d_blog_module->getThemes();
        $data['layout_types'] = $this->model_module_d_blog_module->getLayouts();
        ...
        //get config
        $data['config_files'] = $this->model_module_d_blog_module->getConfigFiles($this->codename);
    ...
    public function install() {
        $this->load->model('module/d_blog_module');
        $this->model_module_d_blog_module->createTables( );
        $this->model_module_d_blog_module->updateTables();
        ...
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'access', $this->codename.'/category');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'modify', $this->codename.'/category');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'access', $this->codename.'/post');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'modify', $this->codename.'/post');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'access', $this->codename.'/review');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'modify', $this->codename.'/review');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'access', $this->codename.'/author');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'modify', $this->codename.'/author');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'access', $this->codename.'/author_group');
        $this->model_user_user_group->addPermission($this->model_module_d_blog_module->getGroupId(), 'modify', $this->codename.'/author_group');
    }
    ...
    */
    ...
    public function enabledSslUrl(){
        ...
        if (!$this->user->hasPermission('modify', $this->route) || !isset($ssl_url)) {
            ...
            $this->model_module_d_blog_module->enabledSSLUrl($ssl_url);
