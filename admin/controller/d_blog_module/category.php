...
class ControllerDBlogModuleCategory extends Controller {
    ...
    public function __construct($registry) {
        ...
        $this->setting = $this->model_module_d_blog_module->getConfigData($this->codename, $this->codename.'_setting', $this->config->get('config_store_id'),$this->config_file);
    }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/d_blog_module', 'token=' . $this->session->data['token'], 'SSL')
            );
